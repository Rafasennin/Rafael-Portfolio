...
const messages = {
  en: {
    ...
    fileFile: 'File',
    fileLength: 'Size',
    fileUploadDate: 'Uploaded',
    fileAction: 'Delete',
    download: 'Download',
    fileEmail: 'Email',
    fileMessage: "Message",
    confirmDeletePhrase: 'Do you confirm the deletion ?',
    cancelDelete: ' Cancel',
  ...
  pt: {
    ...
    fileFile: 'Arquivo',
    fileLength: 'Tamanho',
    fileUploadDate: 'Carregado',
    fileAction: 'Deletar',
    download: 'Baixar',
    fileEmail: 'Email',
    fileMessage: "Mensagem",
    confirmDeletePhrase: 'Confirma a deleção ?',
  ...
  he: {
    ...
    fileIndex: 'אינדקס',
    fileLength: 'גודל',
    fileUploadDate: 'הועלה',
    fileName: 'שם',
    fileFile: 'קובץ',
    fileAction: 'למחוק',
    download: 'הורד',
    fileEmail: 'אימייל',
    fileMessage: "הוֹדָעָה",
    confirmDeletePhrase: '? האם אתה מאשר את המחיקה',
    cancelDelete: ' לבטל',
    confirmDelete: 'לאשר',
